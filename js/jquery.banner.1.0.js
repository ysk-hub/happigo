;(function($,jQuery){
    ...
    $.fn.banner=function(options){
        ...
        this._obj.leftClick=function(){
            ...
            // console.log(that._obj.index,that._obj.iPrev)
            that._obj.btnMove(1);
        }
        ...
        this._obj.btnMove=function(type){
            ...
            if(!this.list) return;
            that.children(".list").children("li").css("background","rgba(200,200,200,0.7)").eq(this.index).css("background","red")
        }
        ...
        if(this._obj.list){
            ...
            this._obj.listMove=function(iNow,type){
                ...
                that.children(".list").children("li").css("background","rgba(200,200,200,0.7)").eq(iNow).css("background","red")
            }
